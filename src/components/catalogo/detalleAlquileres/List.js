                    ...
                    <Paper style={{
                        ...
                        <Table>
                            <TableHead>
                                <TableRow>
                                    <TableCell>#</TableCell>
                                    <TableCell >alquiler_fecha</TableCell>
                                    <TableCell >descripcion de la oficina</TableCell>
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >{d.alquiler_fecha}</TableCell>
                                        <TableCell >{d.descripcion_nro_oficina}</TableCell>
                                        <TableCell >s/.{d.precio}</TableCell>
                                        <TableCell >{d.cantidad}</TableCell>
                                        <TableCell >{d.fecha}</TableCell>
                                        <TableCell >.s/.{d.importe}</TableCell>
                                       
                                        
                                     
                                        <TableCell >
                                         
                                            <Link to={`/catalogo/detalleAlquileres/edit/${d.id}`}  ><EditIcon color="blue" /></Link>
                                        </TableCell>
                                       <TableCell >
