                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >{d.apellidoPaterno}</TableCell>
                                        <TableCell >{d.apellidoMaterno}</TableCell>
                                        <TableCell >{d.fechaNacimiento}</TableCell>
                                        <TableCell >{d.genero}</TableCell>
                                        <TableCell >{d.email}</TableCell>
                                        <TableCell >
                                        <Link to={`/core/personas/edit/${d.id}`}  ><EditIcon color="blue" /></Link>
